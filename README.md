...
| :--- | :--- | :--- | :--- |
| **Store Admin** | `admin@localshop.com` | `Admin@12345` | [/admin](http://localhost:3000/admin) or [/auth/login](http://localhost:3000/auth/login) |
| **Demo Customer** | `customer@localshop.com` | `Customer@12345` | [/auth/login](http://localhost:3000/auth/login) |
