...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      success(`Product "${name}" created successfully with ${images.length} photos!`);
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center justify-between bg-slate-900 border border-slate-800 p-5 rounded-3xl shadow-xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-heading font-extrabold text-xl text-white">Add New Product</h1>
            <p className="text-xs text-slate-400">Add an inventory item to your store catalog</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-3xl space-y-4 shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Kashmiri Royal Gala Apples"
            ...
            <div>
              ...
              <input
                ...
                placeholder="kashmiri-royal-gala-apples"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. 1 kg, 500g, Pack of 2, 1 Litre"
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-emerald-500"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Crisp & sweet organic apples from Kashmir orchards"
              className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-emerald-500"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Full nutritional benefits, storage advice, and sourcing details..."
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="240 (for discount badge)"
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-emerald-500"
              />
            </div>
            <div>
          ...
          <div className="bg-slate-800/60 p-4 rounded-2xl border border-slate-700/80 space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-400 mb-1.5">
                Option 3: Or 1-Click Preset Grocery Photos (Append)
              </label>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span>{loading ? "Creating..." : "Save & Publish Product"}</span>
          </button>
          <Link
            href="/admin/products"
